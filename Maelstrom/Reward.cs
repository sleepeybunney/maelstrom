...
namespace Sleepey.Maelstrom
{
    public class Reward
    {
        public static List<Reward> Major = new List<Reward>()
        {
            ...
            //new Reward("quezacotl", RewardType.GF, 0),
            //new Reward("shiva", RewardType.GF, 1),
            new Reward("ifrit", RewardType.GF, 2),
            new Reward("siren", RewardType.GF, 3),
            new Reward("brothers", RewardType.GF, 4),
            new Reward("diablos", RewardType.GF, 5),
            new Reward("carbuncle", RewardType.GF, 6),
            new Reward("leviathan", RewardType.GF, 7),
            new Reward("pandemona", RewardType.GF, 8),
            new Reward("cerberus", RewardType.GF, 9),
            new Reward("alexander", RewardType.GF, 10),
            new Reward("doomtrain", RewardType.GF, 11),
            new Reward("bahamut", RewardType.GF, 12),
            new Reward("cactuar", RewardType.GF, 13),
            new Reward("tonberry", RewardType.GF, 14),
            new Reward("eden", RewardType.GF, 15),
