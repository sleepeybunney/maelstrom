...
namespace FF8Mod
{
    public partial class BattleScript
    {
        ...
        public static Dictionary<byte, string> Elements;
        public static Dictionary<byte, string> StatusCodes;
        public static Dictionary<byte, string> Targets;
        public static Dictionary<byte, string> Groups;
        public static Dictionary<byte, string> Friends;
        public static Dictionary<byte, string> ActionTypes;
        public static Dictionary<byte, string> MenuCommands;
        public static Dictionary<byte, string> LevelBands;
        public static Dictionary<byte, string> Genders;
        public static Dictionary<byte, string> PercentageModifiers;
        ...
        static BattleScript()
        {
            ...
            ConditionCodes = new Dictionary<byte, string>()
            {
                { 0x00, "target-hp" },
            ...
            Operators = new Dictionary<byte, string>()
            {
                { 0x00, "==" },
                { 0x01, "<" },
                { 0x02, ">" },
            ...
            UnaryOperators = new Dictionary<byte, string>()
            {
                { 0x00, "==" },
                { 0x03, "!=" }
            };

            Elements = new Dictionary<byte, string>()
            {
                { 0x00, "fire" },
                { 0x01, "ice" },
                { 0x02, "lightning" },
            ...
            Groups = new Dictionary<byte, string>()
            {
                // 0x10-0x9e = enemy-id + 0x10
                { 0xc8, "enemies" },
                { 0xc9, "friends" }
            ...
            Friends = new Dictionary<byte, string>()
            {
                // 0x00-0x07 = friend-index
                { 0xc8, "self" }
            };

            ActionTypes = new Dictionary<byte, string>()
            {
                { 0x00, "physical" },
                { 0x01, "magic" }
            };

            MenuCommands = new Dictionary<byte, string>()
            {
                { 0x01, "attack" },
                { 0x02, "magic" },
                { 0x04, "item" },
            ...
            Genders = new Dictionary<byte, string>()
            {
                { 0xca, "male" },
                { 0xcb, "female" }
            };

            PercentageModifiers = new Dictionary<byte, string>()
            {
                { 0x00, "0%" },
                { 0x01, "10%" },
                { 0x02, "20%" },
